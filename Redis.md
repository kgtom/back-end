...
<p>大多数情况下，在实际开发中使用redis的时候，只会setvalue和getvalue两个操作，对redis整体缺乏一个认知，所以对redis常见问题做一个总结，希望能够弥补知识盲点。</p>
<h3 id="复习要点">复习要点?</h3>
<p>本文围绕以下几点进行阐述<br>
...
<h2 id="总结">总结</h2>
<p>本文对redis的常见问题做了一个总结。<strong>不推荐大家临时抱佛脚</strong>，真正碰到一些有经验的工程师。</p>
<blockquote>
<p>reference：</p>
</blockquote>
